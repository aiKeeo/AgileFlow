...
- `templates/dev-quickstart.md`（构思/写码/可运行检查表）

- `templates/dev-rationale.md`

- `examples/dev-exemplar-BE.md` 或 `dev-exemplar-FE.md`

- `templates/code-conventions.md`、`templates/ac-guide.md`
...
| `②` | `anti-skip` + [写码闸门自检](dev-quickstart.md#写码闸门write-前) |
...
1. **① 构思** — Read exemplar → 按质量要求写 `atlas/dev/T-xxx-*.md`（摘要五 bullet + 原子步骤表≥3）→ **禁止写业务源码**
