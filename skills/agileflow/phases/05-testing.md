...
1. **5A 归档**（逐 REQ）：复跑 `test/ac/` → 更新 AC 状态列 → 出 `specs/tests/REQ-XXX-验收报告.md` → REQ 已实现
2. **5B 回归**（全部完成后）：全量 L1–L5 → 更新 `specs/tests/README.md` → PASS / BLOCKED-HUMAN / FAIL
...
| 文件 | 说明 |
|------|------|
| `specs/tests/REQ-XXX-验收报告.md` | 每 REQ 一份 |
