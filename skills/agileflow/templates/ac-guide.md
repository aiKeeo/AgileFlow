...
| 顺序 | ① 完整模板落盘 → 闸门 A → 勾① → 闸门 B → ② → ③（**严谨**一～九标题；**快速**一+五+八+九；**禁止摘要版**） |
...
- **5-0（强制入场）**：**architecture 存在的端** **G1 编译** → **G2 启动探针** → **G3 功能冒烟**；不过禁止 5A（见 [l1-l5-pipeline 5-0](l1-l5-pipeline.md#阶段-5-入场门禁50) · [05-testing](../phases/05-testing.md#5-0-入场门禁强制)）  
