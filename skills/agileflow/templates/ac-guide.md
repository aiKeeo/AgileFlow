...
| 顺序 | ① 完整模板落盘 → 构思闸门 → 勾① → 写码闸门 → ② → **可运行闸门（编译+能启/接口+冒烟）** → ③（**严谨**一～九标题；**快速**一+五+八+九；**禁止摘要版**） |
