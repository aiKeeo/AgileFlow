...
→ **① 构思落盘** `specs/dev/T-000-BE.md`（七段齐全）→ **勾 todo ①**  
→ **② 按 五、核心流程 写码** → **勾 todo ②**  
→ **③ 对照 REQ 跑 test/ac 全绿** → **九** 回填 → **勾 todo ③** → T-000 父任务 ✅  
→ 下一任务重复；**全部父任务 ✅** → **AskQuestion 阶段闸门** → **停止**

**首行声明示例**：
`📍 Agileflow | 模式：严谨 | 阶段：4-开发 | 步骤：①构思落盘 | 任务：T-000 | dev：specs/dev/T-000-BE.md | todo：①进行中`

---

## 示例 4：阶段完成却不提问（违规）

**❌** 写完 REQ 标已确认 → 直接写 `specs/model/`  
**❌** 方案 README 标已确认 → 同回复建 `specs/dev/` 并写码  
